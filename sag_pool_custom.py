...
#robert notes
#changed name to SAGPoolingCustom
#cloned the score pre-drop
#IT NOW RETURNS AN EXTRA ARGUMENT: pre_drop_score
#score[perm] carries kept scores, sorted from high to low
#pre_drop_score carries all scores in same index order as nodess

class SAGPoolingCustom(torch.nn.Module):
    ...
    def forward(
        ...
        pre_drop_score = score.clone() #added by me
        ...
        return x, edge_index, edge_attr, batch, perm, score[perm], pre_drop_score #added pre_drop_score
